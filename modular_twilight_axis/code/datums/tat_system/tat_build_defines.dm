...
#define TAT_AVAILABLE_STATS_LIST \
	...
	STATKEY_INT = TAT_STAT_ENTRY("Intelligence", 1, 10, 6, 13), \
...
#define TAT_AVAILABLE_TRAITS_LIST \
	...
	TAT_TRAIT_SPELLBLADE = TAT_TRAIT_ENTRY("Spellblade", 2, TAT_CATEGORY_CLASS_MODULE, TAT_CATEGORY_CLASS_MODULE_NAME, "Grants Arcyne Training and a set of weapon-binding spells."), \
	...
	TAT_TRAIT_MAGE_INITIATE = TAT_TRAIT_ENTRY("Mage Initiate", 1, TAT_CATEGORY_CLASS_MODULE, TAT_CATEGORY_CLASS_MODULE_NAME, "Grants one major spell, two minor spells, six utility spells, plus one extra utility per Arcane skill level."), \
	...
	TAT_TRAIT_MAGE_MINOR_SLOT = TAT_TRAIT_ENTRY("Arcane Minor Slot", 2, TAT_CATEGORY_CLASS_MODULE, TAT_CATEGORY_CLASS_MODULE_NAME, "Requires Mage Initiate. Grants +1 minor spell slot."), \
...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/rogueweapon/halberd/bardiche/scythe = TAT_ITEM_ENTRY("War Scythe", 3, "weapon", "weapon_supply", TAT_SUPPLY_STEEL, "polearm"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/full/raneshen_plated = TAT_ITEM_ENTRY("Ranesheni Rlate Armor", 4, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor"), \
	...
	/obj/item/clothing/under/roguetown/tights/sailor = TAT_ITEM_ENTRY("Sailor Pants", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "pants"), \
	...
	/obj/item/clothing/head/roguetown/helmet/heavy/psybucket = TAT_ITEM_ENTRY("Psydonic Bucket", 2, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	...
	/obj/item/clothing/suit/roguetown/armor/basiceast/captainrobe = TAT_ITEM_ENTRY("Foreign Robes", 3, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	...
	/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/atgervi = TAT_ITEM_ENTRY("Varangian Hauberk", 4, "clothing", "armor_family", TAT_ARMOR_PLATE, "suit"), \
	...
	/obj/item/clothing/neck/roguetown/psicross/noc = TAT_ITEM_ENTRY("Noc Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/noc/bronze = TAT_ITEM_ENTRY("Bronze Noc Amulet", 1, "clothing", "armor_family", TAT_SUPPLY_BRONZE, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/noc/aalloy = TAT_ITEM_ENTRY("Decreipt Noc Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross = TAT_ITEM_ENTRY("Psycross", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/reform = TAT_ITEM_ENTRY("Reformist Cross", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/aalloy = TAT_ITEM_ENTRY("Psycross", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/aalloy = TAT_ITEM_ENTRY("Zizo Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/iron = TAT_ITEM_ENTRY("Zizo Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/matthios = TAT_ITEM_ENTRY("Matthios Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/graggar = TAT_ITEM_ENTRY("Graggar Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/baotha = TAT_ITEM_ENTRY("Baotha Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/undivided = TAT_ITEM_ENTRY("Tennit Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/astrata = TAT_ITEM_ENTRY("Astrata Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/abyssor = TAT_ITEM_ENTRY("Abyssor Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/dendor = TAT_ITEM_ENTRY("Dendor Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/necra = TAT_ITEM_ENTRY("Necra Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/pestra = TAT_ITEM_ENTRY("Pestra Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/ravox = TAT_ITEM_ENTRY("Ravox Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/bronze = TAT_ITEM_ENTRY("Bronze Zizo Amulet", 1, "clothing", "armor_family", TAT_SUPPLY_BRONZE, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/ravox/bronze = TAT_ITEM_ENTRY("Bronze Ravox Amulet", 1, "clothing", "armor_family", TAT_SUPPLY_BRONZE, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/astrata/bronze = TAT_ITEM_ENTRY("Bronze Astrata Amulet", 1, "clothing", "armor_family", TAT_SUPPLY_BRONZE, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/malum/bronze = TAT_ITEM_ENTRY("Bronze Malum Amulet", 1, "clothing", "armor_family", TAT_SUPPLY_BRONZE, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/graggar/bronze = TAT_ITEM_ENTRY("Bronze Graggar Amulet", 1, "clothing", "armor_family", TAT_SUPPLY_BRONZE, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/malum = TAT_ITEM_ENTRY("Malum Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/eora = TAT_ITEM_ENTRY("Eora Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/xylix = TAT_ITEM_ENTRY("Xylix Amulet", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/wood = TAT_ITEM_ENTRY("Wooden Psycross", 0, "clothing", "armor_family", TAT_SUPPLY_IRON, "misc"),\
	/obj/item/clothing/neck/roguetown/psicross/bronze = TAT_ITEM_ENTRY("Bronze Psycross", 1, "clothing", "armor_family", TAT_SUPPLY_BRONZE, "misc"),\
