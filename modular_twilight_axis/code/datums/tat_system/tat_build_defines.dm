...
#define TAT_AVAILABLE_TRAITS_LIST \
	...
	TAT_TRAIT_HERETIC= TAT_TRAIT_ENTRY("Heretic", -1, TAT_CATEGORY_CLASS_MODULE, TAT_CATEGORY_CLASS_MODULE_NAME, "Gain HERETIC! mark on your face."), \
...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/clothing/wrists/roguetown/bracers/brigandine = TAT_ITEM_ENTRY("Brigandine Rerebraces", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "wrists"), \
	...
	/obj/item/clothing/wrists/roguetown/bracers/cloth/monk = TAT_ITEM_ENTRY("Monk Wrappings", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "wrists"), \
	...
	/obj/item/rogue/instrument/lute = TAT_ITEM_ENTRY("Lute", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/rogue/instrument/accord = TAT_ITEM_ENTRY("Accord", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/rogue/instrument/guitar = TAT_ITEM_ENTRY("Guitar", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/rogue/instrument/harp = TAT_ITEM_ENTRY("Harp", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/rogue/instrument/flute = TAT_ITEM_ENTRY("Flute", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/rogue/instrument/drum = TAT_ITEM_ENTRY("Drum", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/rogue/instrument/shamisen = TAT_ITEM_ENTRY("Shamisen", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/rogue/instrument/vocals = TAT_ITEM_ENTRY("Vocal's Talisman", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/rogue/instrument/viola = TAT_ITEM_ENTRY("Viola", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	...
	/datum/crafting_recipe/roguetown/survival/rod = TAT_ITEM_ENTRY("Fishing Rod", 0.5, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/fishingrod/bronze = TAT_ITEM_ENTRY("Bronze Fishing Rod", 0.5, "weapon", "weapon_supply", TAT_SUPPLY_BRONZE, "misc"), \
	...
	/obj/item/bottle_kit = TAT_ITEM_ENTRY("Bottling Kit", 4, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/natural/worms/leech/cheele = TAT_ITEM_ENTRY("Cheele", 3, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/heart_blood_canister/filled = TAT_ITEM_ENTRY("Hearhblood Canister", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/bait/leech = TAT_ITEM_ENTRY("Leech Bait", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	...
	/obj/item/repair_kit = TAT_ITEM_ENTRY("Fabric Patch", 4, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/millstone = TAT_ITEM_ENTRY("Millstone", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
