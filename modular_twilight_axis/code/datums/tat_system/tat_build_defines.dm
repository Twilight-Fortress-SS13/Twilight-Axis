...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/clothing/under/roguetown/chainlegs/skirt = TAT_ITEM_ENTRY("Steel Chain Skirt", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "pants"), \
	...
	/obj/item/gun/ballistic/revolver/grenadelauncher/crossbow/heavy = TAT_ITEM_ENTRY("Siegebow", 5, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "ranged"), \
