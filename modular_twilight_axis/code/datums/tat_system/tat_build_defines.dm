...
#define TAT_AVAILABLE_TRAITS_LIST \
	...
	TAT_TRAIT_ARTIFACTS_SUPPLIER = TAT_TRAIT_ENTRY("Artifacts Bearer", 4, TAT_CATEGORY_SUPPLY, TAT_CATEGORY_SUPPLY_NAME, "You're one of the adventurers with stories about your raids. Now, you have one of the deadlist weapons in Grimmoria. REQUIRES: Party Leader"), \
...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/cuirass/fluted = TAT_ITEM_ENTRY("Fluted Cuirass", 4, "clothing", "armor_family", TAT_ARMOR_MAIL, "armor"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/fluted/ornate = TAT_ITEM_ENTRY("Psydonic Half-Plate", 5, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor"), \
	/obj/item/clothing/suit/roguetown/armor/plate/full = TAT_ITEM_ENTRY("Steel Plate Armor", 4, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/full/fluted/ornate = TAT_ITEM_ENTRY("Psydonic Plate", 6, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor"), \
	...
	/obj/item/clothing/under/roguetown/trou = TAT_ITEM_ENTRY("Work Trousers", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	/obj/item/clothing/under/roguetown/trou/leather = TAT_ITEM_ENTRY("Leather Trousers", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	...
	/obj/item/storage/belt/rogue/leather = TAT_ITEM_ENTRY("Leather Belt", 2, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/plaquesilver = TAT_ITEM_ENTRY("Silver Belt", 2, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/steel/tasset = TAT_ITEM_ENTRY("Tasseted Belt", 2, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/rope = TAT_ITEM_ENTRY("Rope Belt", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/black = TAT_ITEM_ENTRY("Black Leather Belt", 2, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/cloth = TAT_ITEM_ENTRY("Cloth Belt", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
 	/obj/item/clothing/suit/roguetown/shirt/undershirt/black = TAT_ITEM_ENTRY("Shirt", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	...
	/obj/item/clothing/gloves/roguetown/angle/atgervi = TAT_ITEM_ENTRY("Fur-Lined Leather Gloves ", 2, "clothing", "armor_family", TAT_ARMOR_PLATE, "wrists"), \
	...
	/obj/item/clothing/gloves/roguetown/angle/gronn = TAT_ITEM_ENTRY("Gronnic Fur-Lined Leather Gloves", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "gloves"), \
	...
	/obj/item/rogueweapon/scabbard/sword/kazengun/noparry = TAT_ITEM_ENTRY("Ceremonial Kazengun Scabbard for Ssangsudo", 1, "weapon", "weapon_supply", TAT_SUPPLY_STEEL, "sword"), \
	...
	/obj/item/clothing/suit/roguetown/shirt/dress/captainrobe = TAT_ITEM_ENTRY("Foreign Robes", 3, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	...
	/obj/item/rogueweapon/shield/tower/metal = TAT_ITEM_ENTRY("Kite Shield", 3, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "shield"), \
