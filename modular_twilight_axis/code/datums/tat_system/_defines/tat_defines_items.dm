...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/clothing/neck/roguetown/psicross/silver = TAT_ITEM_ENTRY("Silver Psycross", 2, "misc", "armor_family", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/astrata = TAT_ITEM_ENTRY("Silver Astrata Cross", 2, "misc", "armor_family", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/undivided = TAT_ITEM_ENTRY("Silver Tennite cross", 2, "misc", "armor_family", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/necra = TAT_ITEM_ENTRY("Silver Necra Cross", 2, "misc", "armor_family", TAT_SUPPLY_SILVER, "cross"),\
	...
	/obj/item/clothing/suit/roguetown/armor/plate/bronze/light = TAT_ITEM_ENTRY("Bronze Cardiophylax", 1, "clothing", "armor_family",  TAT_ARMOR_LEATHER, "armor"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/cuirass/copper = TAT_ITEM_ENTRY("Copper Cuirass", 1, "clothing", "armor_family", "armor", TAT_ARMOR_LEATHER), \
	...
	/obj/item/clothing/cloak/tabard/stabard/surcoat = TAT_ITEM_ENTRY("Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/clothing/cloak/tabard/stabard/surcoat/short = TAT_ITEM_ENTRY("Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/clothing/cloak/apron/cook = TAT_ITEM_ENTRY("Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/clothing/cloak/sleevedtabard = TAT_ITEM_ENTRY("Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
