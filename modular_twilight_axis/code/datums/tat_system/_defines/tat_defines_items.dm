...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/clothing/neck/roguetown/psicross/silver = TAT_ITEM_ENTRY("Silver Psycross", 2, "clothing", "armor_family", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/astrata = TAT_ITEM_ENTRY("Silver Astrata Cross", 2, "clothing", "armor_family", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/undivided = TAT_ITEM_ENTRY("Silver Tennite cross", 2, "clothing", "armor_family", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/necra = TAT_ITEM_ENTRY("Silver Necra Cross", 2, "clothing", "armor_family", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/noc = TAT_ITEM_ENTRY("Silver Noc Cross", 2, "weapon", "weapon_supply", TAT_SUPPLY_SILVER, "cross"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/bronze/light = TAT_ITEM_ENTRY("Bronze Cardiophylax", 1, "clothing", "armor_family", "armor", null), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/fluted = TAT_ITEM_ENTRY("Fluted Half-Plate", 4, "clothing", "armor_family", TAT_ARMOR_MAIL, "armor"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/full/samsibsa = TAT_ITEM_ENTRY("Samsibsa Scaleplate", 3, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/scale = TAT_ITEM_ENTRY("Scalemail", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "armor"), \
	...
	/obj/item/rogueweapon/scabbard/gwstrap = TAT_ITEM_ENTRY("Greatweapon Strap", 1, "misc", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	...
	/obj/item/storage/belt/rogue/surgery_bag = TAT_ITEM_ENTRY("Surgeon's Bag", 3, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
	...
	/obj/item/tent_kit/ger = TAT_ITEM_ENTRY("Ger Tent", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/tent_kit/yurt = TAT_ITEM_ENTRY("Yurt Tent", 3, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	...
	/obj/item/clothing/head/roguetown/helmet/bascinet/atgervi = TAT_ITEM_ENTRY("Owl Helmet", 4, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	...
	/obj/item/reagent_containers/glass/bottle/alchemical/healthpot = TAT_ITEM_ENTRY("Health Vial", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
	/obj/item/reagent_containers/glass/bottle/alchemical/manapot = TAT_ITEM_ENTRY("Mana Vial", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
	/obj/item/reagent_containers/glass/bottle/alchemical/strpot = TAT_ITEM_ENTRY("Strength Vial", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
	/obj/item/reagent_containers/glass/bottle/alchemical/perpot = TAT_ITEM_ENTRY("Perception Vial", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "mimedicalsc"), \
	/obj/item/reagent_containers/glass/bottle/alchemical/conpot = TAT_ITEM_ENTRY("Constitution Vial", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
	/obj/item/reagent_containers/glass/bottle/alchemical/endpot = TAT_ITEM_ENTRY("Willpower Vial", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
	/obj/item/reagent_containers/glass/bottle/alchemical/spdpot = TAT_ITEM_ENTRY("Haste Vial", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
	/obj/item/reagent_containers/glass/bottle/alchemical/lucpot = TAT_ITEM_ENTRY("Lucky Vial", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
	/obj/item/reagent_containers/glass/bottle/rogue/manapot = TAT_ITEM_ENTRY("Mana Bottle", 3, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
	...
	/obj/item/clothing/neck/roguetown/psicross/noc = TAT_ITEM_ENTRY("Noc Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/noc/bronze = TAT_ITEM_ENTRY("Bronze Noc Amulet", 1, "weapon", "weapon_supply", TAT_SUPPLY_BRONZE, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/noc/aalloy = TAT_ITEM_ENTRY("Decreipt Noc Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross = TAT_ITEM_ENTRY("Psycross", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/reform = TAT_ITEM_ENTRY("Reformist Cross", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/aalloy = TAT_ITEM_ENTRY("Zizo Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/iron = TAT_ITEM_ENTRY("Zizo Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/matthios = TAT_ITEM_ENTRY("Matthios Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/graggar = TAT_ITEM_ENTRY("Graggar Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/baotha = TAT_ITEM_ENTRY("Baotha Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/undivided = TAT_ITEM_ENTRY("Tennit Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/astrata = TAT_ITEM_ENTRY("Astrata Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/abyssor = TAT_ITEM_ENTRY("Abyssor Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/dendor = TAT_ITEM_ENTRY("Dendor Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/necra = TAT_ITEM_ENTRY("Necra Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/pestra = TAT_ITEM_ENTRY("Pestra Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/ravox = TAT_ITEM_ENTRY("Ravox Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/bronze = TAT_ITEM_ENTRY("Bronze Zizo Amulet", 1, "weapon", "weapon_supply", TAT_SUPPLY_BRONZE, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/ravox/bronze = TAT_ITEM_ENTRY("Bronze Ravox Amulet", 1, "weapon", "weapon_supply", TAT_SUPPLY_BRONZE, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/astrata/bronze = TAT_ITEM_ENTRY("Bronze Astrata Amulet", 1, "weapon", "weapon_supply", TAT_SUPPLY_BRONZE, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/malum/bronze = TAT_ITEM_ENTRY("Bronze Malum Amulet", 1, "weapon", "weapon_supply", TAT_SUPPLY_BRONZE, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/inhumen/graggar/bronze = TAT_ITEM_ENTRY("Bronze Graggar Amulet", 1, "weapon", "weapon_supply", TAT_SUPPLY_BRONZE, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/malum = TAT_ITEM_ENTRY("Malum Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/eora = TAT_ITEM_ENTRY("Eora Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/xylix = TAT_ITEM_ENTRY("Xylix Amulet", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/wood = TAT_ITEM_ENTRY("Wooden Psycross", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/bronze = TAT_ITEM_ENTRY("Bronze Psycross", 1, "weapon", "weapon_supply", TAT_SUPPLY_BRONZE, "cross"),\
	...
	/obj/item/reagent_containers/food/snacks/rogue/crackerscooked = TAT_ITEM_ENTRY("Crackers", 0.5, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "food"), \
	/obj/item/reagent_containers/food/snacks/rogue/raisinbread = TAT_ITEM_ENTRY("Raisin Bread", 1, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "food"), \
	/obj/item/reagent_containers/food/snacks/rogue/meat/coppiette = TAT_ITEM_ENTRY("Coppiette", 0.5, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "food"), \
	/obj/item/reagent_containers/food/snacks/rogue/bread = TAT_ITEM_ENTRY("Bread",  0.5, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "food"), \
	/obj/item/reagent_containers/glass/bottle/rogue/beer = TAT_ITEM_ENTRY("Beer",  1, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "food"), \
	/obj/item/reagent_containers/food/snacks/rogue/meat/salami = TAT_ITEM_ENTRY("Salami", 1, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "food"), \
	...
	/obj/item/rogue/instrument/lute = TAT_ITEM_ENTRY("Lute", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	/obj/item/rogue/instrument/accord = TAT_ITEM_ENTRY("Accord", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	/obj/item/rogue/instrument/guitar = TAT_ITEM_ENTRY("Guitar", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	/obj/item/rogue/instrument/harp = TAT_ITEM_ENTRY("Harp", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	/obj/item/rogue/instrument/flute = TAT_ITEM_ENTRY("Flute", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	/obj/item/rogue/instrument/drum = TAT_ITEM_ENTRY("Drum", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	/obj/item/rogue/instrument/shamisen = TAT_ITEM_ENTRY("Shamisen", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	/obj/item/rogue/instrument/vocals = TAT_ITEM_ENTRY("Vocal's Talisman", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	/obj/item/rogue/instrument/viola = TAT_ITEM_ENTRY("Viola", 0, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	...
	/obj/item/reagent_containers/glass/bottle/waterskin/milk = TAT_ITEM_ENTRY("Not Milk....", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "food"), \
	...
	/obj/item/natural/worms/leech/cheele = TAT_ITEM_ENTRY("Cheele", 3, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "medical"), \
