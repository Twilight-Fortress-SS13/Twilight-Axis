...
#define TAT_AVAILABLE_ITEMS_LIST \
	/obj/item/tat_trader_lootbox/cheap = TAT_ITEM_ENTRY("Cheap Trader Cache", 2, "misc", TAT_UNLOCK_TYPE_TRAIT, "tat_trader_license", "trader cache"), \
	/obj/item/tat_trader_lootbox/medium = TAT_ITEM_ENTRY("Merchant Trader Cache", 5, "misc", TAT_UNLOCK_TYPE_TRAIT, "tat_trader_license", "trader cache"), \
	/obj/item/tat_trader_lootbox/expensive = TAT_ITEM_ENTRY("Luxury Trader Cache", 10, "misc", TAT_UNLOCK_TYPE_TRAIT, "tat_trader_license", "trader cache"), \
	...
	/obj/item/clothing/neck/roguetown/psicross/silver = TAT_ITEM_ENTRY("Silver Psycross", 2, "misc", "weapon_supply", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/astrata = TAT_ITEM_ENTRY("Silver Astrata Cross", 2, "misc", "weapon_supply", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/undivided = TAT_ITEM_ENTRY("Silver Tennite cross", 2, "misc", "weapon_supply", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/necra = TAT_ITEM_ENTRY("Silver Necra Cross", 2, "misc", "weapon_supply", TAT_SUPPLY_SILVER, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/silver/noc = TAT_ITEM_ENTRY("Silver Noc Cross", 2, "misc", "weapon_supply", TAT_SUPPLY_SILVER, "cross"), \
	...
	/obj/item/clothing/head/roguetown/helmet/bronze = TAT_ITEM_ENTRY("Bronze Helmet", 2, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	/obj/item/clothing/head/roguetown/helmet/bronzegladiator = TAT_ITEM_ENTRY("Bronze Murmillo", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	/obj/item/clothing/head/roguetown/helmet/heavy/barbute = TAT_ITEM_ENTRY("Barbute", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	...
	/obj/item/clothing/head/roguetown/helmet/heavy/bucket = TAT_ITEM_ENTRY("Steel Bucket Helmet", 2, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	/obj/item/clothing/head/roguetown/helmet/heavy/bucket/crusader = TAT_ITEM_ENTRY("Sugarloaf Helmet", 2, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	...
	/obj/item/clothing/head/roguetown/helmet/kettle/wide = TAT_ITEM_ENTRY("Wide Kettle", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	...
	/obj/item/clothing/head/roguetown/helmet/sallet/beastskull = TAT_ITEM_ENTRY("Beastskull", 4, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	...
	/obj/item/clothing/mask/rogue/facemask/psydonmask = TAT_ITEM_ENTRY("Psydonic Mask", 1.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "mask"), \
	/obj/item/clothing/mask/rogue/facemask/steel/miragefen_rogue = TAT_ITEM_ENTRY("Migarefen Mask", 2, "clothing", "armor_family", TAT_ARMOR_PLATE, "mask"), \
	...
	/obj/item/clothing/mask/rogue/facemask/copper = TAT_ITEM_ENTRY("Copper Mask", 1, "clothing", "armor_family", TAT_ARMOR_MAIL, "mask"), \
	/obj/item/clothing/mask/rogue/facemask/steel = TAT_ITEM_ENTRY("Steel Mask", 2, "clothing", "armor_family", TAT_ARMOR_PLATE, "mask"), \
	/obj/item/clothing/mask/rogue/wildguard = TAT_ITEM_ENTRY("Wildguard Mask", 2, "clothing", "armor_family", TAT_ARMOR_PLATE, "mask"), \
	...
	/obj/item/clothing/mask/rogue/facemask/steel/kazengun/yohei = TAT_ITEM_ENTRY("Demon's Half-Mask", 1, "clothing", "armor_family", TAT_ARMOR_MAIL, "mask"), \
	...
	/obj/item/clothing/neck/roguetown/gorget/forlorncollar = TAT_ITEM_ENTRY("Forlorn Gorget", 2, "clothing", "armor_family", TAT_ARMOR_CLOTH, "neck"), \
	...
	/obj/item/clothing/neck/roguetown/gorget/steel = TAT_ITEM_ENTRY("Steel Gorget", 2, "clothing", "armor_family", TAT_ARMOR_PLATE, "neck"), \
	...
	/obj/item/clothing/shoes/roguetown/armor/rumaclan = TAT_ITEM_ENTRY("Heavy Sandals", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "shoes"), \
	...
	/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk = TAT_ITEM_ENTRY("Steel Hauberk", 3.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "unterarmor"), \
	/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/grenzelhoft = TAT_ITEM_ENTRY("Grenzelhoftian Hip-Shirt w/hauberk", 3.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "unterarmor"), \
	/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/iron = TAT_ITEM_ENTRY("Iron Hauberk", 2.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "unterarmor"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/iron/banded= TAT_ITEM_ENTRY("Iron Branded Armor", 2.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor"), \
	...
	/obj/item/clothing/under/roguetown/chainlegs/skirt = TAT_ITEM_ENTRY("Steel Chain Skirt", 2, "clothing", "armor_family", TAT_ARMOR_MAIL, "pants"), \
	...
	/obj/item/clothing/under/roguetown/chainlegs/gronn = TAT_ITEM_ENTRY("Gronn Byrine Chausses", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "pants"), \
	...
	/obj/item/storage/belt/rogue/leather/sash  = TAT_ITEM_ENTRY("Cloth Sash", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	...
	/obj/item/flashlight/flare/torch/lantern = TAT_ITEM_ENTRY("Iron Lamptern", 1, "misc", "weapon_supply", TAT_SUPPLY_IRON, "adventur' supply"), \
	...
	/obj/item/clothing/gloves/roguetown/angle/atgervi = TAT_ITEM_ENTRY("Fur-Lined Leather Gloves ", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "gloves"), \
	/obj/item/clothing/gloves/roguetown/angle/feld = TAT_ITEM_ENTRY("Stranger Doc Gloves ", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "gloves"), \
	/obj/item/clothing/gloves/roguetown/angle/phys = TAT_ITEM_ENTRY("Straying Surg Gloves ", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "gloves"), \
	...
	/obj/item/clothing/head/roguetown/helmet/bascinet/atgervi/gronn = TAT_ITEM_ENTRY("Gronnic Ravager Helm", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	...
	/obj/item/clothing/head/roguetown/helmet/bascinet/atgervi/gronn/ownel = TAT_ITEM_ENTRY("Gronn Ownel Helm", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	...
	/obj/item/storage/belt/rogue/pouch/coins/poor = TAT_ITEM_ENTRY("Poor Coins Pouch", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "wealth"), \
	...
	/obj/item/storage/belt/rogue/pouch= TAT_ITEM_ENTRY("Empty Coins Pouch", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "wealth"), \
	...
	/obj/item/clothing/suit/roguetown/armor/brigandine/harayoroi = TAT_ITEM_ENTRY("Light Hansimhae Cuirass", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "armor"), \
	...
	/obj/item/storage/gadget/messkit = TAT_ITEM_ENTRY("Mess Kit", 1.5, "misc", "weapon_supply", TAT_SUPPLY_IRON, "adventur' supply"), \
	/obj/item/bedroll = TAT_ITEM_ENTRY("Bedroll", 2, "misc", "weapon_supply", TAT_SUPPLY_IRON, "adventur' supply"), \
	...
	/obj/item/runicflask = TAT_ITEM_ENTRY("Runic Flask", 3, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "munition"), \
	...
	/obj/item/rogueweapon/stoneaxe/battle/ice = TAT_ITEM_ENTRY("Deathfrost Axe", 13, "weapon", "weapon_supply", TAT_SUPPLY_ARTIFACTS, "artifact"), \
	/obj/item/rogueweapon/sword/long/exe/berserk = TAT_ITEM_ENTRY("Berserk Sword", 13, "weapon", "weapon_supply", TAT_SUPPLY_ARTIFACTS, "artifact"), \
	...
	/obj/item/clothing/gloves/roguetown/chain/gronn = TAT_ITEM_ENTRY("Gronn Byrine Gloves", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "gloves"), \
	...
	/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/atgervi = TAT_ITEM_ENTRY("Varangian Hauberk", 4, "clothing", "armor_family", TAT_ARMOR_MAIL, "unterarmor"), \
	...
	/obj/item/clothing/head/roguetown/helmet/heavy/knight/raneshi_hmamluk = TAT_ITEM_ENTRY("Mamluk", 3, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	/obj/item/clothing/head/roguetown/helmet/heavy/knight/raneshi_hmamluk/raneshi_vmamluk = TAT_ITEM_ENTRY("Beastish Mamluk", 3, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	/obj/item/clothing/head/roguetown/helmet/raneshi_jarhelmet = TAT_ITEM_ENTRY("Jar Helmet", 3, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	...
	/obj/item/clothing/neck/roguetown/psicross/inhumen/matthios/moneta = TAT_ITEM_ENTRY("Pierced Coin Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	...
	/obj/item/needle/bronze = TAT_ITEM_ENTRY("Needle", 0.5, "misc", "weapon_supply", TAT_SUPPLY_BRONZE, "medical"), \
	...
	/obj/structure/table/wood/folding = TAT_ITEM_ENTRY("Folding Table", 3, "misc", "weapon_supply", TAT_SUPPLY_BRONZE, "adventur' supply"), \
	...
	/obj/item/clothing/gloves/roguetown/plate/iron/banded = TAT_ITEM_ENTRY("Branded Iron Gauntlets", 2, "clothing", "armor_family", TAT_ARMOR_PLATE, "gloves"), \
	...
	/obj/item/storage/magebag = TAT_ITEM_ENTRY("Scholar's Pouch", 2, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "magic"), \
	/obj/item/clothing/head/roguetown/spellcasterhat = TAT_ITEM_ENTRY("Spellsinger Hat", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "head"), \
