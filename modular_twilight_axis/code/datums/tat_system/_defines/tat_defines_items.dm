...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/reagent_containers/glass/bottle/alchemical = TAT_ITEM_ENTRY("Empty Vial", 0.25, "misc", "weapon_supply", TAT_SUPPLY_IRON, "lyfe"), \
	/obj/item/reagent_containers/glass/bottle= TAT_ITEM_ENTRY("Empty Bottle", 0.25, "misc", "weapon_supply", TAT_SUPPLY_IRON, "lyfe"), \
	...
	/obj/item/clothing/shoes/roguetown/shalal/reinforced = TAT_ITEM_ENTRY("Reinforced Babouche", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "shoes"), \
	/obj/item/cushion/desert1 = TAT_ITEM_ENTRY("Desert Cushion", 0.5, "misc", "weapon_supply", TAT_SUPPLY_IRON, "lyfe"), \
	/obj/item/cushion/desert2 = TAT_ITEM_ENTRY("Desert Cushion", 0.5, "misc", "weapon_supply", TAT_SUPPLY_IRON, "lyfe"), \
