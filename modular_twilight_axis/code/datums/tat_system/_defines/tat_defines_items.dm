...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/folding_peddler_stored = TAT_ITEM_ENTRY("Folding Peddler", 5, "misc", TAT_UNLOCK_TYPE_TRAIT, "tat_trader_license", "trader cache"), \
	...
	/obj/item/rogueweapon/sword/miaodao = TAT_ITEM_ENTRY("Miaodao", 5.5, "weapon", "weapon_supply", TAT_SUPPLY_STEEL, "greatsword"), \
	/obj/item/rogueweapon/scabbard/sword/miaodao = TAT_ITEM_ENTRY("Miaodao Scabbard", 0, "misc", "weapon_supply", TAT_SUPPLY_STEEL, "sheath"), \
	...
	/obj/item/clothing/mask/rogue/yoruku_oni/armored = TAT_ITEM_ENTRY("Wooden Oni Mask", 0.5, "clothing", "weapon_supply", TAT_SUPPLY_IRON, "mask"), \
	/obj/item/clothing/mask/rogue/yoruku_kitsune/armored = TAT_ITEM_ENTRY("Wooden Kitsune Mask", 0.5, "clothing", "weapon_supply", TAT_SUPPLY_IRON, "mask"), \
	...
	/obj/item/clothing/mask/rogue/facemask/steel/miragefen_rogue = TAT_DONATION_ITEM_ENTRY("Migarefen Mask", 2, "clothing", "weapon_supply", TAT_SUPPLY_STEEL, "mask", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/grenzelhoft = TAT_DONATION_ITEM_ENTRY("Grenzelhoftian Hip-Shirt w/hauberk", 2.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "unterarmor", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/suit/roguetown/armor/leather/heavy/coat/raneshen/new_coat = TAT_DONATION_ITEM_ENTRY("Raneshene Light Scale Coat", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/suit/roguetown/armor/leather/studded/cuirbouilli = TAT_ITEM_ENTRY("Cuir-bouilli armor", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/full/raneshen_plated = TAT_DONATION_ITEM_ENTRY("Ranesheni Rlate Armor", 3.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/wrists/roguetown/bracers/twilight_elven = TAT_ITEM_ENTRY("Elver Rider Bracers", 2.5, "clothing", "armor_family", TAT_ARMOR_LEATHER, "wrists"), \
	...
	/obj/item/clothing/head/roguetown/helmet/heavy/knight/raneshi_hmamluk = TAT_DONATION_ITEM_ENTRY("Mamluk", 2.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head", TAT_DONATION_TIER_TWO), \
	/obj/item/clothing/head/roguetown/helmet/heavy/knight/raneshi_hmamluk/raneshi_vmamluk = TAT_DONATION_ITEM_ENTRY("Beastish Mamluk", 2.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/rogueweapon/shield/iron/zybantine = TAT_ITEM_ENTRY("Brass Shield", 2, "weapon", "weapon_supply", TAT_SUPPLY_BRONZE, "shield"), \
	/obj/item/rogueweapon/woodstaff/riddle_of_steel/serpent = TAT_ITEM_ENTRY("Staff of the Serpent", 6, "weapon", "weapon_supply", TAT_SUPPLY_ARTIFACTS, "polearm"), \
	/obj/item/rogueweapon/sword/long/kriegmesser/zybantine = TAT_ITEM_ENTRY("Heavy Scimitar", 3, "weapon", "weapon_supply", TAT_SUPPLY_STEEL, "sword"), \
	/obj/item/rogueweapon/sword/sabre/shamshir/steel = TAT_ITEM_ENTRY("Steel Shamshir", 3, "weapon", "weapon_supply", TAT_SUPPLY_STEEL, "sword"), \
	/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/janissary = TAT_ITEM_ENTRY("Janissary Chainmail", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "unterarmor"), \
	/obj/item/clothing/suit/roguetown/armor/brigandine/agha = TAT_ITEM_ENTRY("Agha Scale", 3, "clothing", "armor_family", TAT_ARMOR_MAIL, "armor"), \
	/obj/item/clothing/head/roguetown/helmet/janissaryhelm = TAT_ITEM_ENTRY("Janissary Helmet", 1.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	/obj/item/clothing/suit/roguetown/armor/leather/vest/open = TAT_ITEM_ENTRY("Open Leather Vest", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	/obj/item/clothing/suit/roguetown/armor/leather/vest/open/purple = TAT_ITEM_ENTRY("Purple Open Leather Vest", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	/obj/item/clothing/suit/roguetown/armor/leather/vest/open/blue = TAT_ITEM_ENTRY("Blue Open Leather Vest", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	/obj/item/clothing/suit/roguetown/armor/leather/vest/open/red = TAT_ITEM_ENTRY("Red Open Leather Vest", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	/obj/item/clothing/suit/roguetown/armor/leather/vest/open/orange = TAT_ITEM_ENTRY("Orange Open Leather Vest", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	/obj/item/clothing/suit/roguetown/armor/leather/vest/open/green = TAT_ITEM_ENTRY("Green Open Leather Vest", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	/obj/item/clothing/suit/roguetown/armor/leather/vest/open/brown = TAT_ITEM_ENTRY("Brown Open Leather Vest", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht = TAT_ITEM_ENTRY("Bisht", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht/grey = TAT_ITEM_ENTRY("Grey Bisht", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht/red = TAT_ITEM_ENTRY("Red Bisht", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht/blue = TAT_ITEM_ENTRY("Blue Bisht", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht/brown = TAT_ITEM_ENTRY("Brown Bisht", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht/beige = TAT_ITEM_ENTRY("Beige Bisht", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht/black = TAT_ITEM_ENTRY("Black Bisht", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht/bluegrey = TAT_ITEM_ENTRY("Fine Grey Bisht", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht/purple = TAT_ITEM_ENTRY("Purple Bisht", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/robe/bisht/merchantbisht = TAT_ITEM_ENTRY("Guild Bisht", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/dress/thawb = TAT_ITEM_ENTRY("Thawb", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/dress/thawb/black = TAT_ITEM_ENTRY("Black Thawb", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/dress/thawb/blue = TAT_ITEM_ENTRY("Blue Thawb", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/dress/thawb/red = TAT_ITEM_ENTRY("Red Thawb", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/dress/thawb/beige = TAT_ITEM_ENTRY("Beige Thawb", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	...
	/obj/item/clothing/head/roguetown/turban/dark = TAT_ITEM_ENTRY("Dark Turban", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "head"), \
	/obj/item/clothing/head/roguetown/turban/grey = TAT_ITEM_ENTRY("Grey Turban", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "head"), \
	...
	/obj/item/clothing/under/roguetown/sirwal/black = TAT_ITEM_ENTRY("Black Sirwal", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	/obj/item/clothing/under/roguetown/sirwal/fancy = TAT_ITEM_ENTRY("Fancy Sirwal", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	/obj/item/clothing/under/roguetown/sirwal/fancy/red = TAT_ITEM_ENTRY("Red Fancy Sirwal", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	/obj/item/clothing/under/roguetown/sirwal/fancy/blue = TAT_ITEM_ENTRY("Blue Fancy Sirwal", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	/obj/item/clothing/under/roguetown/sirwal/fancy/purple = TAT_ITEM_ENTRY("Purple Fancy Sirwal", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	/obj/item/clothing/under/roguetown/sirwal/fancy/yellow = TAT_ITEM_ENTRY("Yellow Fancy Sirwal", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	/obj/item/clothing/under/roguetown/thong = TAT_ITEM_ENTRY("Thong", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	/obj/item/clothing/cloak/dunestalker = TAT_ITEM_ENTRY("Dunestalker Cloak", 1.5, "clothing", "armor_family", TAT_ARMOR_LEATHER, "cloak"), \
	/obj/item/clothing/cloak/citywatch/janissary = TAT_ITEM_ENTRY("Janissary Cape", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/storage/belt/rogue/leather/cloth/sash = TAT_ITEM_ENTRY("Simple Zybantine Sash", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/cloth/sash/yellow = TAT_ITEM_ENTRY("Yellow Zybantine Sash", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/cloth/sash/red = TAT_ITEM_ENTRY("Red Zybantine Sash", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/cloth/sash/orange = TAT_ITEM_ENTRY("Orange Zybantine Sash", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/cloth/sash/brown = TAT_ITEM_ENTRY("Brown Zybantine Sash", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/cloth/sash/purple = TAT_ITEM_ENTRY("Purple Zybantine Sash", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/noblesash = TAT_ITEM_ENTRY("Zybantine Noble Sash", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/jafar = TAT_ITEM_ENTRY("Zybantine Magos Sash", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/exoticsilkbelt/skirtgreen = TAT_ITEM_ENTRY("Green Exotic Silk Skirt", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/storage/belt/rogue/leather/exoticsilkbelt/skirtred = TAT_ITEM_ENTRY("Red Exotic Silk Skirt", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	/obj/item/clothing/suit/roguetown/shirt/exoticsilkbra/green = TAT_ITEM_ENTRY("Green Exotic Silk Bra", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/exoticsilkbra/red = TAT_ITEM_ENTRY("Red Exotic Silk Bra", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/mask/rogue/exoticsilkmask/green = TAT_ITEM_ENTRY("Green Exotic Silk Mask", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "mask"), \
	/obj/item/clothing/mask/rogue/exoticsilkmask/red = TAT_ITEM_ENTRY("Red Exotic Silk Mask", 0.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "mask"), \
	/obj/item/clothing/shoes/roguetown/shalal/reinforced = TAT_ITEM_ENTRY("Fine Babouche", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "shoes"), \
	/obj/item/clothing/shoes/roguetown/boots/armor/shalal = TAT_ITEM_ENTRY("Plated Babouche", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "shoes"), \
	/obj/item/clothing/suit/roguetown/armor/gambeson/zyb = TAT_ITEM_ENTRY("Desert Coat", 2, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
