...
GLOBAL_LIST_INIT(tat_trader_lootbox_cheap_base_pool, list(
	...
	/obj/item/clothing/neck/roguetown/leather = 10,
	...
	/obj/item/clothing/neck/roguetown/psicross/inhumen/aalloy = 10,
...
GLOBAL_LIST_INIT(tat_trader_lootbox_medium_base_pool, list(
	...
	/obj/item/clothing/neck/roguetown/bevor/iron = 7,
	...
	/obj/item/clothing/neck/roguetown/gorget = 7,
	...
	/obj/item/clothing/neck/roguetown/psicross = 7,
	/obj/item/clothing/neck/roguetown/psicross/abyssor = 7,
	/obj/item/clothing/neck/roguetown/psicross/astrata = 7,
	/obj/item/clothing/neck/roguetown/psicross/astrata/g = 7,
	/obj/item/clothing/neck/roguetown/psicross/dendor = 7,
	/obj/item/clothing/neck/roguetown/psicross/eora = 7,
	/obj/item/clothing/neck/roguetown/psicross/g = 7,
	/obj/item/clothing/neck/roguetown/psicross/malum = 7,
	/obj/item/clothing/neck/roguetown/psicross/naledi = 7,
	/obj/item/clothing/neck/roguetown/psicross/necra = 7,
	/obj/item/clothing/neck/roguetown/psicross/noc = 7,
	/obj/item/clothing/neck/roguetown/psicross/pearl = 7,
	/obj/item/clothing/neck/roguetown/psicross/pestra = 7,
	/obj/item/clothing/neck/roguetown/psicross/ravox = 7,
	...
	/obj/item/clothing/neck/roguetown/psicross/undivided = 7,
	/obj/item/clothing/neck/roguetown/psicross/xylix = 7,
...
GLOBAL_LIST_INIT(tat_trader_lootbox_expensive_base_pool, list(
	...
	/obj/item/clothing/neck/roguetown/gorget/paalloy = 4,
	/obj/item/clothing/neck/roguetown/gorget/steel/kazengun = 4,
	/obj/item/clothing/neck/roguetown/psicross/bpearl = 4,
	/obj/item/clothing/neck/roguetown/psicross/inhumen/baotha = 4,
	/obj/item/clothing/neck/roguetown/psicross/inhumen/g = 4,
	/obj/item/clothing/neck/roguetown/psicross/inhumen/graggar = 4,
	/obj/item/clothing/neck/roguetown/psicross/inhumen/matthios = 4,
	/obj/item/clothing/neck/roguetown/psicross/inhumen/paalloy = 4,
	/obj/item/clothing/neck/roguetown/psicross/noc/paalloy = 4,
	/obj/item/clothing/neck/roguetown/psicross/paalloy = 4,
	...
	/obj/item/clothing/suit/roguetown/armor/plate/full/iron = 4,
...
GLOBAL_LIST_INIT(tat_trader_lootbox_jackpot_pool, list(
	...
	/obj/item/clothing/suit/roguetown/armor/plate/full/legacy = 1,
	/obj/item/clothing/suit/roguetown/armor/plate/legacy = 1,
	/obj/item/clothing/suit/roguetown/armor/plate/paalloy = 1,
	/obj/item/clothing/suit/roguetown/armor/plate/paalloy/artificer = 1
))

GLOBAL_LIST_INIT(tat_trader_lootbox_tat_bronze_pool, list(
...
GLOBAL_LIST_INIT(tat_trader_lootbox_tat_steel_pool, list(
	/obj/item/clothing/gloves/roguetown/knuckles = 6,
	/obj/item/gun/ballistic/revolver/grenadelauncher/crossbow = 6,
	/obj/item/gun/ballistic/revolver/grenadelauncher/crossbow/heavy = 3,
	...
	/obj/item/quiver/javelin/steel = 6,
...
GLOBAL_LIST_INIT(tat_trader_lootbox_tat_silver_gear_pool, list(
	/obj/item/quiver/bolt/heavy/silver = 8,
...
GLOBAL_LIST_INIT(tat_trader_lootbox_tat_silver_cross_pool, list(
...
GLOBAL_LIST_INIT(tat_trader_lootbox_party_artifact_pool, list(
	/obj/item/clothing/suit/roguetown/armor/heartfelt = 4,
	/obj/item/rogueweapon/mace/mushroom = 1,
	/obj/item/rogueweapon/shield/tower/metal/psy = 4,
	/obj/item/rogueweapon/stoneaxe/battle/ice = 2,
	/obj/item/rogueweapon/sword/sabre/bane = 1
))

GLOBAL_LIST_INIT(tat_trader_lootbox_stat_jewelry_pool, list(
...
/obj/item/tat_trader_lootbox/proc/generate_cheap_rewards(list/rewards)
	...
	if(roll <= 85)
		tat_add_weighted_lootbox_reward(rewards, GLOB.tat_trader_lootbox_cheap_base_pool)
	else if(roll <= 99)
		tat_add_weighted_lootbox_reward(rewards, GLOB.tat_trader_lootbox_medium_base_pool)
	else
		tat_add_weighted_lootbox_reward(rewards, GLOB.tat_trader_lootbox_expensive_base_pool)
...
/obj/item/tat_trader_lootbox/proc/generate_medium_rewards(list/rewards)
	...
	if(roll <= 80)
		...
		tat_add_weighted_lootbox_reward(rewards, GLOB.tat_trader_lootbox_cheap_base_pool, 2)
	else
		tat_add_weighted_lootbox_reward(rewards, GLOB.tat_trader_lootbox_expensive_base_pool)
...
/obj/item/tat_trader_lootbox/proc/generate_expensive_rewards(list/rewards)
	...
	if(roll <= 60)
		...
		tat_add_weighted_lootbox_reward(rewards, GLOB.tat_trader_lootbox_stat_jewelry_pool)
