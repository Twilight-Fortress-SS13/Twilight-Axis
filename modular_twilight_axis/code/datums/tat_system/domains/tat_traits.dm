...
/datum/tat_traits/proc/get_trait_conflict_map()
	...
	GLOB.tat_trait_conflict_map = list(
		TAT_TRAIT_RESIDENT = list(TRAIT_OUTLANDER, TAT_TRAIT_WANTED, TAT_TRAIT_BONUS_STAT_POOL, TAT_TRAIT_MASTER_OF_WANDERING, TAT_TRAIT_HERETIC, TRAIT_STRONGBITE, TAT_TRAIT_TRADER_LICENSE),
		...
		TAT_TRAIT_WANTED = list(TRAIT_OUTLANDER),
