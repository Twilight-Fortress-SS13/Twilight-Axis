...
/datum/tat_traits/proc/get_trait_conflict_map()
	...
	GLOB.tat_trait_conflict_map = list(
		...
		TAT_TRAIT_MAGE_MAJOR_SLOT = list(TAT_TRAIT_DIVINE_BOON_3, TAT_TRAIT_SPELLBLADE, TAT_TRAIT_SPELLFIST),
		...
		TAT_TRAIT_HUNTER_BEATER = list(TAT_TRAIT_HUNTER_SHOOTER, TAT_TRAIT_RONIN, TAT_TRAIT_SOUNDBREAKER, TAT_TRAIT_MASTER_OF_CRAFTING, TRAIT_SMITHING_EXPERT, TAT_TRAIT_SKILLED_FORGEHAND, TAT_TRAIT_SKILLED_ARMORER, TAT_TRAIT_SKILLED_WEAPONSMITH, TAT_TRAIT_SKILLED_ARTISAN, TAT_TRAIT_SKILLED_WOODSMAN, TAT_TRAIT_MASTER_CRAFTSMAN, TAT_TRAIT_SKILLED_MASON, TAT_TRAIT_SKILLED_COOK, TRAIT_ALCHEMY_EXPERT, TAT_TRAIT_SKILLED_ALCHEMIST, TRAIT_MEDICINE_EXPERT, TAT_TRAIT_SKILLED_PHYSICKER, TRAIT_HOMESTEAD_EXPERT, TRAIT_SELF_SUSTENANCE, TRAIT_SURVIVAL_EXPERT, TAT_TRAIT_SKILLED_SURVIVALIST, TRAIT_SEWING_EXPERT, TAT_TRAIT_SKILLED_CLOTHIER, TRAIT_SEEDKNOW, TRAIT_CAUTIOUS_FISHER, TRAIT_SQUIRE_REPAIR),
		TAT_TRAIT_HUNTER_SHOOTER = list(TAT_TRAIT_HUNTER_BEATER, TAT_TRAIT_RONIN, TAT_TRAIT_SOUNDBREAKER, TAT_TRAIT_MASTER_OF_CRAFTING, TRAIT_SMITHING_EXPERT, TAT_TRAIT_SKILLED_FORGEHAND, TAT_TRAIT_SKILLED_ARMORER, TAT_TRAIT_SKILLED_WEAPONSMITH, TAT_TRAIT_SKILLED_ARTISAN, TAT_TRAIT_SKILLED_WOODSMAN, TAT_TRAIT_MASTER_CRAFTSMAN, TAT_TRAIT_SKILLED_MASON, TAT_TRAIT_SKILLED_COOK, TRAIT_ALCHEMY_EXPERT, TAT_TRAIT_SKILLED_ALCHEMIST, TRAIT_MEDICINE_EXPERT, TAT_TRAIT_SKILLED_PHYSICKER, TRAIT_HOMESTEAD_EXPERT, TRAIT_SELF_SUSTENANCE, TRAIT_SURVIVAL_EXPERT, TAT_TRAIT_SKILLED_SURVIVALIST, TRAIT_SEWING_EXPERT, TAT_TRAIT_SKILLED_CLOTHIER, TRAIT_SEEDKNOW, TRAIT_CAUTIOUS_FISHER, TRAIT_SQUIRE_REPAIR),
