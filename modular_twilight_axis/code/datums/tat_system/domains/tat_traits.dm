...
/datum/tat_traits/proc/get_trait_conflict_map()
	...
	GLOB.tat_trait_conflict_map = list(
		TAT_TRAIT_RESIDENT = list(TRAIT_OUTLANDER, TAT_TRAIT_WANTED, TAT_TRAIT_BONUS_STAT_POOL, TAT_TRAIT_MASTER_OF_WANDERING, TAT_TRAIT_HERETIC, TRAIT_STRONGBITE, TAT_TRAIT_TRADER_LICENSE, TAT_TRAIT_WARRIOR_EXPERT, TAT_TRAIT_DIVINE_BOON_3, TAT_TRAIT_SOUNDBREAKER, TAT_TRAIT_MARTIAL_MASTER, TAT_TRAIT_RONIN, TAT_TRAIT_SPELLBLADE, TRAIT_HEAVYARMOR, TRAIT_MEDIUMARMOR, TAT_TRAIT_SAVAGE_SKIN, TAT_TRAIT_SAVAGE_RAGE, TRAIT_CIVILIZEDBARBARIAN,TRAIT_CRITICAL_RESISTANCE,TRAIT_NOPAINSTUN,TRAIT_HARDDISMEMBER),
		...
		TAT_TRAIT_SOUNDBREAKER = list(TAT_TRAIT_RONIN, TAT_TRAIT_SPELLBLADE, TAT_TRAIT_MARTIAL_MASTER),
		TAT_TRAIT_MARTIAL_MASTER = list(TAT_TRAIT_SOUNDBREAKER, TAT_TRAIT_RONIN, TAT_TRAIT_SPELLBLADE),
		TAT_TRAIT_SPELLBLADE = list(TAT_TRAIT_RONIN, TAT_TRAIT_SOUNDBREAKER, TAT_TRAIT_MARTIAL_MASTER, TAT_TRAIT_DIVINE_BOON_2, TAT_TRAIT_MAGE_MAJOR_SLOT),
