...
/datum/tat_build/proc/init_available_stats()
	available_stats = list(
		...
		STATKEY_PER = list("name" = "Perception", "cost" = 1, "base" = 10, "min" = 1, "max" = 20),
		STATKEY_INT = list("name" = "Intelligence", "cost" = 1, "base" = 10, "min" = 1, "max" = 20),
		STATKEY_CON = list("name" = "Constitution", "cost" = 1, "base" = 10, "min" = 1, "max" = 20),
		STATKEY_WIL = list("name" = "Willpower", "cost" = 1, "base" = 10, "min" = 1, "max" = 20),
		STATKEY_SPD = list("name" = "Speed", "cost" = 2, "base" = 10, "min" = 1, "max" = 20),
		STATKEY_LCK = list("name" = "Fortune", "cost" = 0.5, "base" = 10, "min" = 1, "max" = 20),
	)
...
/datum/tat_build/proc/init_available_traits()
	available_traits = list(
		...
		TAT_TRAIT_WARRIOR_MASTER = make_trait_entry("Master Warrior", 5, "combat_mastery"),

		TRAIT_DODGEEXPERT = make_trait_entry("Expert Dodger", 3, "defense"),
		TRAIT_PARRYEXPERT = make_trait_entry("Expert Parry", 3, "defense"),
		TRAIT_HEAVYARMOR = make_trait_entry("Plate Training", 3, "defense"),
		TRAIT_MEDIUMARMOR = make_trait_entry("Maille Training", 2, "defense"),
		TRAIT_NOPAINSTUN = make_trait_entry("Enduring", 3, "defense"),
		TRAIT_CRITICAL_RESISTANCE = make_trait_entry("Critical Resistance", 4, "defense"),
		...
		TAT_TRAIT_SILVER_SUPPLIER = make_trait_entry("Silver Supplier", 4, "supply", "Unlocks silver-tier weapons."),
		TAT_TRAIT_STEEL_SUPPLIER = make_trait_entry("Steel Supplier", 3, "supply", "Unlocks steel-tier weapons."),
		...
		TRAIT_WITCH = make_trait_entry("Witch Presence", 3, "oddity"),
...
/datum/tat_build/proc/init_available_items()
	available_items = list(
		...
		/obj/item/rogueweapon/greatsword/grenz = make_item_entry("Zweihander", 4, "weapon", "weapon_supply", "steel", "greatsword"),
		...
		/obj/item/rogueweapon/greatsword/zwei = make_item_entry("Claymore", 5, "weapon", "weapon_supply", "steel", "greatsword"),
		...
		/obj/item/rogueweapon/huntingknife/combat/bronze = make_item_entry("Bronze Knife", 2, "weapon", "weapon_supply", "bronze", "knife"),
		...
		/obj/item/rogueweapon/flail/alt = make_item_entry("Flail, Studded", 2, "weapon", "weapon_supply", "steel", "blunt"),
		...
		/obj/item/rogueweapon/sword/short/messer/alt = make_item_entry("Hunting Sword", 2, "weapon", "weapon_supply", "steel", "sword"),
		...
		//CLOTHING
		/obj/item/clothing/gloves/roguetown/angle = make_item_entry("Heavy Leather Gloves", 1, "clothing", "armor_family", "cloth", "gloves"),
		/obj/item/clothing/gloves/roguetown/angle/grenzelgloves = make_item_entry("Grenzelhoft Gloves", 1, "clothing", "armor_family", "cloth", "gloves"),
		/obj/item/clothing/gloves/roguetown/eastgloves1 = make_item_entry("Swordsman Gloves", 1, "clothing", "armor_family", "cloth", "gloves"),
		/obj/item/clothing/gloves/roguetown/eastgloves2 = make_item_entry("Stylish Bandages", 1, "clothing", "armor_family", "cloth", "gloves"),
		/obj/item/clothing/gloves/roguetown/elven_gloves = make_item_entry("Elven Gloves", 2, "clothing", "armor_family", "cloth", "gloves"),
		...
		/obj/item/clothing/gloves/roguetown/plate/kote = make_item_entry("Jjajeungna Gauntlets", 3, "clothing", "armor_family", "plate", "gloves"),
		/obj/item/clothing/head/roguetown/armingcap = make_item_entry("Arming cap", 1, "clothing", "armor_family", "cloth", "head"),
		/obj/item/clothing/head/roguetown/armingcap/padded = make_item_entry("Padded Arming Cap", 1, "clothing", "armor_family", "cloth", "head"),
		/obj/item/clothing/head/roguetown/cap = make_item_entry("Cloth Cap", 1, "clothing", "armor_family", "cloth", "head"),
		/obj/item/clothing/head/roguetown/helmet/bascinet = make_item_entry("Bascinet", 3, "clothing", "armor_family", "plate", "head"),
		/obj/item/clothing/head/roguetown/helmet/bascinet/etruscan = make_item_entry("Etruscan Bacinet", 3, "clothing", "armor_family", "plate", "head"),
		/obj/item/clothing/head/roguetown/helmet/bascinet/pigface = make_item_entry("Pigface Bacinet", 3, "clothing", "armor_family", "plate", "head"),
		/obj/item/clothing/head/roguetown/helmet/bascinet/pigface/hounskull = make_item_entry("Hounskull Bacinet", 3, "clothing", "armor_family", "plate", "head"),
		/obj/item/clothing/head/roguetown/helmet/bronze = make_item_entry("Bronze Helmet", 3, "clothing", "armor_family", "plate", "head"),
		/obj/item/clothing/head/roguetown/helmet/bronzegladiator = make_item_entry("Bronze Murmillo", 3, "clothing", "armor_family", "plate", "head"),
		/obj/item/clothing/head/roguetown/helmet/coppercap = make_item_entry("Copper cap", 3, "clothing", "armor_family", "plate", "head"),
		/obj/item/clothing/head/roguetown/helmet/elvenbarbute = make_item_entry("Elven barbute", 3, "clothing", "armor_family", "plate", "head"),
		/obj/item/clothing/head/roguetown/helmet/elvenbarbute/winged = make_item_entry("Winged Elven Barbute", 3, "clothing", "armor_family", "plate", "head"),
		...
		/obj/item/clothing/head/roguetown/helmet/heavy/frogmouth = make_item_entry("Frogmouth", 4, "clothing", "armor_family", "plate", "head"),
		...
		/obj/item/clothing/mask/rogue/facemask/steel/steppesman = make_item_entry("Steppesman Mask", 1, "clothing", "armor_family", "cloth", "mask"),
		/obj/item/clothing/neck/roguetown/bevor = make_item_entry("Bevor", 3, "clothing", "armor_family", "plate", "neck"),
		/obj/item/clothing/neck/roguetown/bevor/bronze = make_item_entry("Bronze Bevor", 3, "clothing", "armor_family", "plate", "neck"),
		/obj/item/clothing/neck/roguetown/bevor/iron = make_item_entry("Iron Bevor", 3, "clothing", "armor_family", "plate", "neck"),
		...
		/obj/item/clothing/neck/roguetown/coif/heavypadding = make_item_entry("Heavy Padded Coif", 2, "clothing", "armor_family", "mail", "neck"),
		/obj/item/clothing/neck/roguetown/coif/padded = make_item_entry("Padded Coif", 2, "clothing", "armor_family", "mail", "neck"),
		/obj/item/clothing/neck/roguetown/gorget = make_item_entry("Gorget", 3, "clothing", "armor_family", "neck"),
		/obj/item/clothing/neck/roguetown/gorget/bronze = make_item_entry("Bronze Gorget", 3, "clothing", "armor_family", "neck"),
		/obj/item/clothing/neck/roguetown/gorget/copper = make_item_entry("Copper Gorget", 3, "clothing", "armor_family", "neck"),
		/obj/item/clothing/neck/roguetown/gorget/steel = make_item_entry("Steel Gorget", 3, "clothing", "armor_family", "plate", "neck"),
		...
		/obj/item/clothing/suit/roguetown/armor/leather/heavy/coat/raneshen/new_coat = make_item_entry("Raneshene Light Scale Coat", 3, "clothing", "armor_family", "leather", "suit"),
		/obj/item/clothing/suit/roguetown/armor/leather/heavy/coat/steppe = make_item_entry("Steppesman Coat", 2, "clothing", "armor_family", "leather", "suit"),
		/obj/item/clothing/suit/roguetown/armor/leather/heavy/freifechter = make_item_entry("Freifechter Jacket", 2, "clothing", "armor_family", "leather", "suit"),
		...
		/obj/item/clothing/suit/roguetown/armor/leather/studded/cuirbouilli = make_item_entry("Cuirbouilli", 3, "clothing", "armor_family", "leather", "suit"),
		...
		/obj/item/clothing/suit/roguetown/armor/plate/cuirass/copper = make_item_entry("Copper Cuirass", 3, "clothing", "armor_family", "suit"),
		/obj/item/clothing/suit/roguetown/armor/plate/cuirass/fencer = make_item_entry("Fencer Cuirass", 4, "clothing", "armor_family", "leather", "suit"),
		/obj/item/clothing/suit/roguetown/armor/plate/cuirass/fluted = make_item_entry("Fluted", 4, "clothing", "armor_family", "mail", "suit"),
		/obj/item/clothing/suit/roguetown/armor/plate/cuirass/fluted/ornate = make_item_entry("Ornate", 4, "clothing", "armor_family", "mail", "suit"),
		...
		/obj/item/clothing/suit/roguetown/armor/plate/full/bronze = make_item_entry("Full Bronze Plate", 4, "clothing", "armor_family", "plate", "suit"),
		/obj/item/clothing/suit/roguetown/armor/plate/full/bronze/alt = make_item_entry("Full Bronze Plate", 4, "clothing", "armor_family", "plate", "suit"),
		...
		/obj/item/clothing/under/roguetown/brigandinelegs = make_item_entry("Brigandine Legs", 1, "clothing", "armor_family", "cloth", "under"),
		/obj/item/clothing/under/roguetown/chainlegs = make_item_entry("Chain legs", 3, "clothing", "armor_family", "mail", "under"),
		/obj/item/clothing/under/roguetown/chainlegs/iron = make_item_entry("Chainlegs Iron", 3, "clothing", "armor_family", "mail", "under"),
		/obj/item/clothing/under/roguetown/chainlegs/iron/kilt = make_item_entry("Iron Chain Kilt", 3, "clothing", "armor_family", "mail", "under"),
		/obj/item/clothing/under/roguetown/chainlegs/kilt = make_item_entry("Steel Chain Kilt", 3, "clothing", "armor_family", "mail", "under"),
		/obj/item/clothing/under/roguetown/chainlegs/skirt = make_item_entry("Chain Skirt", 3, "clothing", "armor_family", "mail", "under"),
		...
		/obj/item/clothing/under/roguetown/heavy_leather_pants/bronzeskirt = make_item_entry("Bronze skirt", 2, "clothing", "armor_family", "leather", "under"),
		/obj/item/clothing/under/roguetown/heavy_leather_pants/grenzelpants = make_item_entry("Grenzel pants", 2, "clothing", "armor_family", "leather", "under"),
		/obj/item/clothing/under/roguetown/heavy_leather_pants/shadowpants = make_item_entry("Silk Tights", 2, "clothing", "armor_family", "leather", "under"),
		...
		/obj/item/clothing/under/roguetown/platelegs = make_item_entry("Plate legs", 1, "clothing", "armor_family", "cloth", "under"),
		/obj/item/clothing/under/roguetown/platelegs/iron = make_item_entry("Iron Plate legs", 1, "clothing", "armor_family", "cloth", "under"),
		/obj/item/clothing/under/roguetown/splintlegs = make_item_entry("Splint legs", 1, "clothing", "armor_family", "cloth", "under"),
		/obj/item/clothing/under/roguetown/splintlegs/gronn = make_item_entry("Gronn Byrine Chausses", 1, "clothing", "armor_family", "cloth", "under"),
		/obj/item/clothing/under/roguetown/tights/sailor = make_item_entry("Sailor Pants", 1, "clothing", "armor_family", "cloth", "under"),
		/obj/item/clothing/under/roguetown/trou = make_item_entry("Work Trousers", 1, "clothing", "armor_family", "cloth", "under"),
		/obj/item/clothing/under/roguetown/trou/leather = make_item_entry("Leather Trousers", 2, "clothing", "armor_family", "leather", "under"),
		/obj/item/clothing/under/roguetown/trou/leather/gronn = make_item_entry("Fur lined Pants", 2, "clothing", "armor_family", "leather", "under"),
		/obj/item/clothing/under/roguetown/trou/leather/pontifex = make_item_entry("Pontifex's Chaqchur", 2, "clothing", "armor_family", "leather", "under"),
		/obj/item/clothing/under/roguetown/trou/leather/pontifex/raneshen = make_item_entry("Baggy Desert Pants", 2, "clothing", "armor_family", "leather", "under"),
		/obj/item/clothing/under/roguetown/trou/leathertights = make_item_entry("Leather tights", 2, "clothing", "armor_family", "leather", "under"),
		/obj/item/clothing/wrists/roguetown/bracers/brigandine = make_item_entry("Brigandine Bracers", 1, "clothing", "armor_family", "cloth", "wrists"),
		/obj/item/clothing/wrists/roguetown/bracers/bronze = make_item_entry("Bronze Bracers ", 1, "clothing", "armor_family", "cloth", "wrists"),
		/obj/item/clothing/wrists/roguetown/bracers/cloth/monk = make_item_entry("Monk Wrapping", 1, "clothing", "armor_family", "cloth", "wrists"),
		/obj/item/clothing/wrists/roguetown/bracers/copper = make_item_entry("Copper Bracers", 1, "clothing", "armor_family", "cloth", "wrists"),
		/obj/item/clothing/wrists/roguetown/bracers/iron = make_item_entry("Iron Bracers ", 1, "clothing", "armor_family", "cloth", "wrists"),
		/obj/item/clothing/wrists/roguetown/bracers/leather = make_item_entry("Leather Bracers ", 1, "clothing", "armor_family", "leather", "wrists"),
		/obj/item/clothing/wrists/roguetown/bracers/leather/heavy = make_item_entry("Heavy Leather Bracers", 1, "clothing", "armor_family", "leather", "wrists"),
		/obj/item/clothing/wrists/roguetown/bracers/splint = make_item_entry("Splint Bracers", 1, "clothing", "armor_family", "cloth", "wrists"),
		/obj/item/clothing/wrists/roguetown/bracers/twilight_elven = make_item_entry("Elven Bracers", 1, "clothing", "armor_family", "cloth", "wrists"),
	)
