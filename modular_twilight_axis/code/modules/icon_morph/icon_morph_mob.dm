...
#define MORPH_LAYERS list(BODY_ADJ_LAYER, FRONT_MUTATIONS_LAYER, BODY_FRONT_FRONT_LAYER)
#define MORPH_FULL_LAYERS list(BODYPARTS_LAYER, BODY_ADJ_LAYER, FRONT_MUTATIONS_LAYER, BODY_FRONT_FRONT_LAYER)
#define MORPH_REMOVE_LAYERS list(BODY_ADJ_LAYER, FRONT_MUTATIONS_LAYER, BODY_FRONT_FRONT_LAYER)
