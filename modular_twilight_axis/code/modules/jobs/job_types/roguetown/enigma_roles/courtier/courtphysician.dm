...
/datum/advclass/courtphysician
	...
	tutorial = "You are a court physician and the current head of the clinic. \
		Oversee your clinic and the apothecaries under you. \
		Take care of the health of the king and his courtiers, because your well-being depends on it."
	outfit = /datum/outfit/job/roguetown/courtphysician/basic
	category_tags = list(CTAG_COURTPHYSICIAN)
	subclass_stats = list(
		STATKEY_INT = 4,
		STATKEY_WIL = 1,
		STATKEY_LCK = 1,
...
/datum/outfit/job/roguetown/courtphysician
	job_bitflag = BITFLAG_ROYALTY

/datum/outfit/job/roguetown/courtphysician
	name = "Court physician"
	jobtype = /datum/job/roguetown/courtphysician

/datum/outfit/job/roguetown/courtphysician/basic/pre_equip(mob/living/carbon/human/H)
	..()
