...
/datum/customizer_choice/organ/butt/handle_topic(mob/user, list/href_list, datum/preferences/prefs, datum/customizer_entry/entry, customizer_type)
	...
	switch(href_list["customizer_task"])
		if("butt_size")
			var/named_size = input(user, "Choose your butt size:", "Character Preference", find_key_by_value(BUTT_SIZES_BY_NAME, butt_entry.butt_size)) as anything in BUTT_SIZES_BY_NAME
