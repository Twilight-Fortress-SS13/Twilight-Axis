...
/datum/book_entry/disease_compendium/nature/inner_book_html(mob/user)
	...
	Маска врача (Physician's Mask) обеспечивают надежную защиту от контактной передачи болезней.
...
/datum/book_entry/disease_compendium/plague/inner_book_html(mob/user)
	...
	1. <b>Зелье: "Plague Cure (bottle)"</b><br>
	   ...
	   • 1 сердце животного (Heart) - жизненная сила<br>
...
/datum/book_entry/disease_compendium/grime_flu/inner_book_html(mob/user)
	...
	• Обезвоживание организма, жажда<br><br>
	...
	1. <b>Зелье: "The Grime-Flu cure"</b><br>
	   Ингредиенты:<br>
	   • 1 листья мяты (Mentha) - успокаивают дыхательные пути<br>
	   • 1 зверобой (Hypericum) - противовоспалительный эффект<br>
	   • 30 единиц чистой воды (Water) - основа<br>
	   • 1 стеклянная алхимическая бутыль (Glass bottle) - для сосуда<br><br>
	<b>Применение:</b><br>
...
/datum/book_entry/disease_compendium/flu/inner_book_html(mob/user)
	...
	<b>Описание:</b> Способная передача вирусная болезнь, вызывающая общее недомогание и слабость.
