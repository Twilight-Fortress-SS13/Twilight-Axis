/datum/language/gyedzenese
	name = "Gyedzenese"
	desc = "The language of the lands of the former Kingdom of Gyedzai. A concise language with simple grammar and a large number of homophones distinguished by tone."
	speech_verb = "remarks"
	ask_verb = "inquires"
