...
/datum/reagent/consumable/soup/on_mob_life(mob/living/carbon/M)
	if(ishuman(M))
		...
		if(M.urine_volume < URINE_VOLUME_NORMAL)
			M.urine_volume = min(M.urine_volume+10, URINE_VOLUME_NORMAL)
	..()
...
/datum/reagent/consumable/soup/stew/chicken/on_mob_life(mob/living/carbon/M)
	if(!HAS_TRAIT(M,TRAIT_INFINITE_STAMINA))
		M.energy_add(1)
	if(M.urine_volume < URINE_VOLUME_NORMAL)
		M.urine_volume = min(M.urine_volume+1, URINE_VOLUME_MAXIMUM)
...
/datum/reagent/consumable/soup/stew/bakedchicken/on_mob_life(mob/living/carbon/M)
	if(!HAS_TRAIT(M,TRAIT_INFINITE_STAMINA))
		M.energy_add(1)
	if(M.urine_volume < URINE_VOLUME_NORMAL)
		M.urine_volume = min(M.urine_volume+2, URINE_VOLUME_MAXIMUM)
	var/list/wCount = M.get_wounds()
	if(wCount.len > 0)
		M.heal_wounds(1)
	if(volume > 0.99)
...
/datum/reagent/consumable/soup/stew/bakedthickchicken/on_mob_life(mob/living/carbon/M)
	if(!HAS_TRAIT(M,TRAIT_INFINITE_STAMINA))
		M.energy_add(1)
	if(M.urine_volume < URINE_VOLUME_NORMAL)
		M.urine_volume = min(M.urine_volume+3, URINE_VOLUME_MAXIMUM)
	var/list/wCount = M.get_wounds()
	if(wCount.len > 0)
		M.heal_wounds(1)
	if(volume > 0.99)
...
/datum/reagent/consumable/soup/stew/pepperchicken/on_mob_life(mob/living/carbon/M)
	if(!HAS_TRAIT(M,TRAIT_INFINITE_STAMINA))
		M.energy_add(1)
	if(M.urine_volume < URINE_VOLUME_NORMAL)
		M.urine_volume = min(M.urine_volume+4, URINE_VOLUME_MAXIMUM)
	var/list/wCount = M.get_wounds()
	if(wCount.len > 0)
		M.heal_wounds(1)
	if(volume > 0.99)
...
/datum/reagent/consumable/soup/stew/lavishchicken/on_mob_life(mob/living/carbon/M)
	if(!HAS_TRAIT(M,TRAIT_INFINITE_STAMINA))
		M.energy_add(1)
	if(M.urine_volume < URINE_VOLUME_NORMAL)
		M.urine_volume = min(M.urine_volume+5, URINE_VOLUME_MAXIMUM)
	var/list/wCount = M.get_wounds()
	if(wCount.len > 0)
		M.heal_wounds(2)
	if(volume > 0.99)
