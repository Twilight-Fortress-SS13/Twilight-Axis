...
/datum/action/innate/proc/InterceptClickOn(mob/living/clicker, list/modifiers, atom/clicked_on)
	if(!IsAvailable())
...
/datum/action/innate/proc/do_ability(mob/living/clicker, list/modifiers, atom/clicked_on)
	return FALSE
