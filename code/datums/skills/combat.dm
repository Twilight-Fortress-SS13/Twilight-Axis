...
/datum/skill/combat/polearms
	...
	dreams = list(
	"...the pale volf snaps its jaws, but to no avail. Your weapon has the superior reach and you jab at it with precision until it pisss and retreats back into the woods...",
