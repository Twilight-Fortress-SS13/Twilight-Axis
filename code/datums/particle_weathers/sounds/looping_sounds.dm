/datum/looping_sound/rain
	mid_sounds = list('sound/weather/rain/weather_rain.ogg')
	mid_length = 40 SECONDS
	volume = 200
	direct = TRUE

/datum/looping_sound/indoor_rain
	mid_sounds = list('sound/weather/rain/weather_rain_indoors.ogg')
	mid_length = 15 SECONDS
	volume = 500
	direct = TRUE

/datum/looping_sound/storm
	mid_sounds = list('sound/weather/rain/weather_storm.ogg')
	mid_length = 30 SECONDS
	volume = 150
	direct = TRUE
/datum/looping_sound/snow
	mid_sounds = list('sound/weather/snow/weather_snow.ogg')
	mid_length = 50 SECONDS
	volume = 150
	direct = TRUE

/datum/looping_sound/hail
	mid_sounds = list('sound/weather/hail/weather_hail.ogg')
	mid_length = 50 SECONDS
	volume = 110
	direct = TRUE

/datum/looping_sound/indoor_hail
	mid_sounds = list('sound/weather/hail/weather_hail_indoors.ogg')
	mid_length = 30 SECONDS
	volume = 175
	direct = TRUE
