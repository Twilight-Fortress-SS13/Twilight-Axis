...
/obj/item/paper/inqslip/accusation/get_mechanics_examine(mob/user)
	...
	. += span_info("Left click yourself, while pissing from anywhere on the body, to sign the ACCUSATION. This is OPTIONAL.")
...
/obj/item/paper/inqslip/arrival/get_mechanics_examine(mob/user)
	...
	. += span_info("Left click yourself, while pissing fron anywhere on the body, to sign the SLIP.")
