...
/datum/status_effect/black_rot/proc/update_alert()
	...
	switch(tier)
		if(1)
			...
			linked_alert.desc = "A faint darkness spreads beneath my skin. I should seek out a calyx or heart urine vials before it is too late."
			linked_alert.icon_state = "blackrot1"
			examine_text = "SUBJECTPRONOUN seems to be rotting alive! (Creeping)"
		if(2)
			linked_alert.name = "Black Rot (Festering)"
			linked_alert.desc = "My veins run black with corruption. I will surely die if this persists. I should seek out a calyx or heart urine vials before it is too late."
		...
		if(3)
			...
			linked_alert.desc = "My flesh decays and my bones ache. It feels like my skin is boiling. I should seek out a calyx or heart urine vials before it is too late."
		...
		if(4)
			...
			linked_alert.desc = "I am being consumed by the void. I can feel my bones creaking. I should seek out a calyx or heart urine vials now!!"
...
/atom/movable/screen/alert/status_effect/black_rot
	...
	desc = "A faint darkness spreads beneath my skin. I should seek out a calyx or heart urine vials before it is too late."
