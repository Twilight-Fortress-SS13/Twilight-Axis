...
GLOBAL_LIST_INIT(buffrunerituallist, generate_buff_rituallist()) // TA EDIT START
GLOBAL_LIST_INIT(t2buffrunerituallist, generate_t2buff_rituallist()) // TA EDIT END
