...
/datum/species/demihuman
	...
	base_name = "Humen"
	desc_title = "Half-Kin"
	desc = "The inevitable union between wildkin and some form of humanity or another. While they also experience animalistic tendencies akin to their purebred ancestors, their intermingling with others has stemmed the severity of such primordial impulses. (Half-kin are not a template race to play your own custom race. If you play a half-kin, you are expected to roleplay to the setting and the race's lore.)"
