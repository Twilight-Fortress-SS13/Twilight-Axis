...
/datum/reagent/consumable/ethanol/on_mob_life(mob/living/carbon/C)
	...
	if(C.urine_volume < URINE_VOLUME_NORMAL && !holder.has_reagent(/datum/reagent/water))
		C.urine_volume = min(C.urine_volume + ALCOHOL_BLOOD_RESTORE, URINE_VOLUME_NORMAL)
//		if(boozepwr > 0)
