...
/client/proc/respawn_character()
	...
	if(record_found)//If they have a record we can determine a few things.
		...
		new_character.hardset_dna(record_found.fields["identity"], record_found.fields["enzymes"], record_found.fields["name"], record_found.fields["urine_type"], new record_found.fields["species"], record_found.fields["features"])
	else
