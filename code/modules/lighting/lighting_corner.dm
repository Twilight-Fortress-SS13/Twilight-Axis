...
///Returns a list of the (up to 4) turfs this corner touches. Used by roguetown's sunlight system, which needs to queue updates for every turf a corner affects.
