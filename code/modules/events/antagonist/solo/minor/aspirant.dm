...
/datum/round_event/antagonist/solo/aspirants/start()
	...
	var/list/helping = list("Consort" ,"Hand" ,"Suitor" ,"Prince" ,"Captain" ,"Steward" ,"Court Magician ","Archivist", "Knight","Royal Knight", "Marshal", "Councillor", "Town Crier", "Keeper", "Veteran")
