...
/obj/effect/temp_visual/piss
	name = "piss"
	icon = 'icons/effects/piss.dmi'
	icon_state = "piss0"
	duration = 10
	var/shrink = TRUE

/obj/effect/temp_visual/piss/Initialize(mapload, atom/size_calc_target)
	. = ..()
	...
	if(size_calc_target)
		...
		transform = size_matrix //scale the piss overlay's size based on the target's icon size
...
/obj/effect/temp_visual/piss/explode
	icon_state = "piss10"
	duration = 12
	shrink = FALSE
