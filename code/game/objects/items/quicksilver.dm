...
/obj/item/paper/inquisition_poultice_info
	...
	info = {"
		...
		simple strip of cloth to add structure to the poultice. Take the warm bud of a fyritius flower, and immerse it in the pissing wound of an unholy creecher. The warmth
