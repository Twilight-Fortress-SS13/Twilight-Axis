...
/datum/status_effect/buff/cranking_soulchurner
	...
	var/ravoxlines =list("'Равоксианцы! Оторвите голову этой инквизиторской псине! Освободите меня от этого проклятого колдовства!'", "'Здесь нет ни справедливости, ни славы, лишь бесконечная усталость...'", "'Я молю о смерти от меча...'")
	...
	var/matthioslines =list("'Моя последняя сделка... Он никогда не получит мои богатства... Украдены этими монстрами...'", "'Товарищ, я закован в это УЖАСНОЕ УСТРОЙСТВО, освободи МЕНЯ!'", "'Я чувствую, как наши кандалы переплетаются друг с другом...'")
